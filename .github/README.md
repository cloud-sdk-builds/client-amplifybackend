...
[`@aws-sdk/client-amplifybackend`](https://www.npmjs.com/package/@aws-sdk/client-amplifybackend/v/3.855.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.855.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uNpqJootkdWudAplSkfOMD8iPGH4TK/Yl3Sl7X860PxcOHUlOHK4KNrX1/fHw51H
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-amplifybackend": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.855.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.855.0/index.min.mjs": "sha384-uNpqJootkdWudAplSkfOMD8iPGH4TK/Yl3Sl7X860PxcOHUlOHK4KNrX1/fHw51H"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-amplifybackend/blob/refs/tags/3.855.0/LICENSE
```
