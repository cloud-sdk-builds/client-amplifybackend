...
[`@aws-sdk/client-amplifybackend`](https://www.npmjs.com/package/@aws-sdk/client-amplifybackend/v/3.828.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.828.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GPtL3VA4uSgXWSej4StzFm3zLKIGHfa1EzylkRwm2i58Rq5QZBxPxFXY1Tyhv/dy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-amplifybackend": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.828.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.828.0/index.min.mjs": "sha384-GPtL3VA4uSgXWSej4StzFm3zLKIGHfa1EzylkRwm2i58Rq5QZBxPxFXY1Tyhv/dy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-amplifybackend/blob/refs/tags/3.828.0/LICENSE
```
