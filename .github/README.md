...
[`@aws-sdk/client-amplifybackend`](https://www.npmjs.com/package/@aws-sdk/client-amplifybackend/v/3.743.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.743.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lKgZ09m/AbHsz2f9urigerS3g0F5+jDNAaCkLKDHAjQyfzYhVgOB+TlFXtDS4mcS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-amplifybackend": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.743.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.743.0/index.min.mjs": "sha384-lKgZ09m/AbHsz2f9urigerS3g0F5+jDNAaCkLKDHAjQyfzYhVgOB+TlFXtDS4mcS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-amplifybackend/blob/refs/tags/3.743.0/LICENSE
```
