...
[`@aws-sdk/client-amplifybackend`](https://www.npmjs.com/package/@aws-sdk/client-amplifybackend/v/3.264.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.264.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DDMAgxjyPNO2Y+c4C75fOFLGwQEeGBaHTEYo0DZLezUKRvSdBycPZsojttoMtGar
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-amplifybackend": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.264.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.264.0/index.min.mjs": "sha384-DDMAgxjyPNO2Y+c4C75fOFLGwQEeGBaHTEYo0DZLezUKRvSdBycPZsojttoMtGar"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-amplifybackend/blob/refs/tags/3.264.0/LICENSE
```
