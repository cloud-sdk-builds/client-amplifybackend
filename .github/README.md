...
[`@aws-sdk/client-amplifybackend`](https://www.npmjs.com/package/@aws-sdk/client-amplifybackend/v/3.279.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.279.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2+czd/W+eXxXIUejtrw+gCl8t7Uced9u9RTbAdjfrPs8ez691ZhholZE4ojMSHZV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-amplifybackend": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.279.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.279.0/index.min.mjs": "sha384-2+czd/W+eXxXIUejtrw+gCl8t7Uced9u9RTbAdjfrPs8ez691ZhholZE4ojMSHZV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-amplifybackend/blob/refs/tags/3.279.0/LICENSE
```
