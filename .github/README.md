...
[`@aws-sdk/client-amplifybackend`](https://www.npmjs.com/package/@aws-sdk/client-amplifybackend/v/3.24.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.24.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kooWMh7Q+rpF94MsVTR2AioWT8dMBv94pFvlkXvR4r9dD3mo7N1rNyn7R2vX3V4r
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-amplifybackend": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.24.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.24.0/index.min.mjs": "sha384-kooWMh7Q+rpF94MsVTR2AioWT8dMBv94pFvlkXvR4r9dD3mo7N1rNyn7R2vX3V4r"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-amplifybackend/blob/refs/tags/3.24.0/LICENSE
```
