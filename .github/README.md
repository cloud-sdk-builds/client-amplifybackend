...
[`@aws-sdk/client-amplifybackend`](https://www.npmjs.com/package/@aws-sdk/client-amplifybackend/v/3.696.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.696.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YRtHc42pYE6s7z8mHM3mSeDv7BJzMhJj12WLVaeMqtn+SVfrLmK1ZjRn137qZyeA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-amplifybackend": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.696.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.696.0/index.min.mjs": "sha384-YRtHc42pYE6s7z8mHM3mSeDv7BJzMhJj12WLVaeMqtn+SVfrLmK1ZjRn137qZyeA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-amplifybackend/blob/refs/tags/3.696.0/LICENSE
```
