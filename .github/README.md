...
[`@aws-sdk/client-amplifybackend`](https://www.npmjs.com/package/@aws-sdk/client-amplifybackend/v/3.772.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.772.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+hIfkSnlLg+53yMJS2XQ/0Y+oo5rAwXZ1mrnu9ms9rFbQS+qTyw4/pIzj72pRqwn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-amplifybackend": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.772.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.772.0/index.min.mjs": "sha384-+hIfkSnlLg+53yMJS2XQ/0Y+oo5rAwXZ1mrnu9ms9rFbQS+qTyw4/pIzj72pRqwn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-amplifybackend/blob/refs/tags/3.772.0/LICENSE
```
