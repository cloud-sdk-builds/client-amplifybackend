...
[`@aws-sdk/client-amplifybackend`](https://www.npmjs.com/package/@aws-sdk/client-amplifybackend/v/3.699.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.699.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HVYBJy3N+WO14+eAYehyfCTS3XEwHyaqA/cu70X/5/APOceeAvZkKuP43lRTpn/w
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-amplifybackend": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.699.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.699.0/index.min.mjs": "sha384-HVYBJy3N+WO14+eAYehyfCTS3XEwHyaqA/cu70X/5/APOceeAvZkKuP43lRTpn/w"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-amplifybackend/blob/refs/tags/3.699.0/LICENSE
```
