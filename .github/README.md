...
[`@aws-sdk/client-amplifybackend`](https://www.npmjs.com/package/@aws-sdk/client-amplifybackend/v/3.357.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.357.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-prCOZvKqKcFWRLvcB8pH1BlBFicOIQJdyP5qQ0GRm54vFu8PZoi+Y+dzAV5nx8mv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-amplifybackend": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.357.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.357.0/index.min.mjs": "sha384-prCOZvKqKcFWRLvcB8pH1BlBFicOIQJdyP5qQ0GRm54vFu8PZoi+Y+dzAV5nx8mv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-amplifybackend/blob/refs/tags/3.357.0/LICENSE
```
