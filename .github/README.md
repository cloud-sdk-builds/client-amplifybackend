...
[`@aws-sdk/client-amplifybackend`](https://www.npmjs.com/package/@aws-sdk/client-amplifybackend/v/3.75.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.75.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jT6GYZzmLV8eFL8syp8EArplxvee5gtpfAfTYjCIMLOmCKADdROlmDX9s+A8Dmde
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-amplifybackend": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.75.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.75.0/index.min.mjs": "sha384-jT6GYZzmLV8eFL8syp8EArplxvee5gtpfAfTYjCIMLOmCKADdROlmDX9s+A8Dmde"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-amplifybackend/blob/refs/tags/3.75.0/LICENSE
```
