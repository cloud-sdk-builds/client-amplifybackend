...
[`@aws-sdk/client-amplifybackend`](https://www.npmjs.com/package/@aws-sdk/client-amplifybackend/v/3.410.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.410.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qqSL7BYWu7E35WxGwBzJjjNjFInAolHvZGPYTZrjolfsX8h6WQL+sDX/XbO6ssst
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-amplifybackend": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.410.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.410.0/index.min.mjs": "sha384-qqSL7BYWu7E35WxGwBzJjjNjFInAolHvZGPYTZrjolfsX8h6WQL+sDX/XbO6ssst"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-amplifybackend/blob/refs/tags/3.410.0/LICENSE
```
