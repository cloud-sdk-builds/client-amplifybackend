...
[`@aws-sdk/client-amplifybackend`](https://www.npmjs.com/package/@aws-sdk/client-amplifybackend/v/3.23.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.23.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OfeBQhW1/beqkPfOH8F3dFRqTPrgIslcU1IPyf2O1khJ1+kLZPtOgyXZCxxYJmFV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-amplifybackend": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.23.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.23.0/index.min.mjs": "sha384-OfeBQhW1/beqkPfOH8F3dFRqTPrgIslcU1IPyf2O1khJ1+kLZPtOgyXZCxxYJmFV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-amplifybackend/blob/refs/tags/3.23.0/LICENSE
```
