...
[`@aws-sdk/client-amplifybackend`](https://www.npmjs.com/package/@aws-sdk/client-amplifybackend/v/3.252.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.252.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-A62jJRg+V/g0ghkmZfN83y8ljj5Xw18x2wrNaYpfB47tvNomFWDTaFDRF0fk5dEB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-amplifybackend": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.252.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.252.0/index.min.mjs": "sha384-A62jJRg+V/g0ghkmZfN83y8ljj5Xw18x2wrNaYpfB47tvNomFWDTaFDRF0fk5dEB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-amplifybackend/blob/refs/tags/3.252.0/LICENSE
```
