...
[`@aws-sdk/client-amplifybackend`](https://www.npmjs.com/package/@aws-sdk/client-amplifybackend/v/3.741.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.741.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RCatvjsrspHlWL/uu8TXEIUL4EF7nWUpPFYBXG6T1V7rACmFt/s3h8R+gu6rxVeR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-amplifybackend": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.741.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.741.0/index.min.mjs": "sha384-RCatvjsrspHlWL/uu8TXEIUL4EF7nWUpPFYBXG6T1V7rACmFt/s3h8R+gu6rxVeR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-amplifybackend/blob/refs/tags/3.741.0/LICENSE
```
