...
[`@aws-sdk/client-amplifybackend`](https://www.npmjs.com/package/@aws-sdk/client-amplifybackend/v/3.932.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.932.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XcXqxQOnEYt4hQQsO4+1pw5nsDh7M2YdrVCLHbKDoWB4+HBbZztstPIXF7AB6TBi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-amplifybackend": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.932.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.932.0/index.min.mjs": "sha384-XcXqxQOnEYt4hQQsO4+1pw5nsDh7M2YdrVCLHbKDoWB4+HBbZztstPIXF7AB6TBi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-amplifybackend/blob/refs/tags/3.932.0/LICENSE
```
