...
[`@aws-sdk/client-amplifybackend`](https://www.npmjs.com/package/@aws-sdk/client-amplifybackend/v/3.347.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.347.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uOALOoX0819EUh2VVDSD/ElohLjelxCXvcaHt0l9whzR9T6FWv/VmJuZm21mskUx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-amplifybackend": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.347.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.347.0/index.min.mjs": "sha384-uOALOoX0819EUh2VVDSD/ElohLjelxCXvcaHt0l9whzR9T6FWv/VmJuZm21mskUx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-amplifybackend/blob/refs/tags/3.347.0/LICENSE
```
