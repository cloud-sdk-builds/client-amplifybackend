...
[`@aws-sdk/client-amplifybackend`](https://www.npmjs.com/package/@aws-sdk/client-amplifybackend/v/3.533.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.533.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-I0LC93QKEMsDAO7JiKTIUb+3Ar4rUD4jUtHBej7NHbTIczYOmA0+xajajq0Tam//
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-amplifybackend": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.533.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.533.0/index.min.mjs": "sha384-I0LC93QKEMsDAO7JiKTIUb+3Ar4rUD4jUtHBej7NHbTIczYOmA0+xajajq0Tam//"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-amplifybackend/blob/refs/tags/3.533.0/LICENSE
```
