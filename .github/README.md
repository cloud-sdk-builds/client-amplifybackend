...
[`@aws-sdk/client-amplifybackend`](https://www.npmjs.com/package/@aws-sdk/client-amplifybackend/v/3.933.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.933.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CO+eA/OdeS12DB0Yy8+Hsm1HbBWdZLZi0F4RMHt6jeVU11prf+m8iS88e4IIkyJT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-amplifybackend": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.933.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.933.0/index.min.mjs": "sha384-CO+eA/OdeS12DB0Yy8+Hsm1HbBWdZLZi0F4RMHt6jeVU11prf+m8iS88e4IIkyJT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-amplifybackend/blob/refs/tags/3.933.0/LICENSE
```
