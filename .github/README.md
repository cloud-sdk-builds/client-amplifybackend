...
[`@aws-sdk/client-amplifybackend`](https://www.npmjs.com/package/@aws-sdk/client-amplifybackend/v/3.216.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.216.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Kd09bj6nvIBdc9rL1FnAng8xURr2WD78wKoGyF6wnccuwOuJoxqVQHKIYvNU9uNi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-amplifybackend": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.216.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.216.0/index.min.mjs": "sha384-Kd09bj6nvIBdc9rL1FnAng8xURr2WD78wKoGyF6wnccuwOuJoxqVQHKIYvNU9uNi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-amplifybackend/blob/refs/tags/3.216.0/LICENSE
```
