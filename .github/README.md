...
[`@aws-sdk/client-amplifybackend`](https://www.npmjs.com/package/@aws-sdk/client-amplifybackend/v/3.503.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.503.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0LNQAEa/aGKsu40zp62x5h+01TMVulNcCEmSAZevKOdSYRxSSPJfpr6IpJLGOrHq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-amplifybackend": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.503.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.503.0/index.min.mjs": "sha384-0LNQAEa/aGKsu40zp62x5h+01TMVulNcCEmSAZevKOdSYRxSSPJfpr6IpJLGOrHq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-amplifybackend/blob/refs/tags/3.503.0/LICENSE
```
