...
[`@aws-sdk/client-amplifybackend`](https://www.npmjs.com/package/@aws-sdk/client-amplifybackend/v/3.848.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.848.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rXUTAUifHa3dAdp0mRVnKwIueDSymYS21uvGDYFC2lr8ZsBGWZ5624+eqn4I6SWE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-amplifybackend": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.848.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.848.0/index.min.mjs": "sha384-rXUTAUifHa3dAdp0mRVnKwIueDSymYS21uvGDYFC2lr8ZsBGWZ5624+eqn4I6SWE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-amplifybackend/blob/refs/tags/3.848.0/LICENSE
```
