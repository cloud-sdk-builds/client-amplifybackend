...
[`@aws-sdk/client-amplifybackend`](https://www.npmjs.com/package/@aws-sdk/client-amplifybackend/v/3.863.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.863.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-h85QR0sXXCR+fz8DLmDkCYSqwJI1By3NEtUoRLCnh4DS+Gem+widX/Jakq+rznTV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-amplifybackend": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.863.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.863.0/index.min.mjs": "sha384-h85QR0sXXCR+fz8DLmDkCYSqwJI1By3NEtUoRLCnh4DS+Gem+widX/Jakq+rznTV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-amplifybackend/blob/refs/tags/3.863.0/LICENSE
```
