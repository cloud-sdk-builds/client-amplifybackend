...
[`@aws-sdk/client-amplifybackend`](https://www.npmjs.com/package/@aws-sdk/client-amplifybackend/v/3.276.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.276.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xfig+zWhkeMwR6YW+Ci8iXcZ7QAMSR0nrZJg3vDMXyTHBCn7KHS+PaW+ee6z/mm8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-amplifybackend": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.276.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.276.0/index.min.mjs": "sha384-xfig+zWhkeMwR6YW+Ci8iXcZ7QAMSR0nrZJg3vDMXyTHBCn7KHS+PaW+ee6z/mm8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-amplifybackend/blob/refs/tags/3.276.0/LICENSE
```
