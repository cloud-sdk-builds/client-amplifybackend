...
[`@aws-sdk/client-amplifybackend`](https://www.npmjs.com/package/@aws-sdk/client-amplifybackend/v/3.734.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.734.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-L0mUO0NMTarMhY35nSjhAjTBt6N0DjibbbDALD1sGxauJjGUYhoApPwBf1+ZcMRb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-amplifybackend": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.734.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.734.0/index.min.mjs": "sha384-L0mUO0NMTarMhY35nSjhAjTBt6N0DjibbbDALD1sGxauJjGUYhoApPwBf1+ZcMRb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-amplifybackend/blob/refs/tags/3.734.0/LICENSE
```
