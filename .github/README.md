...
[`@aws-sdk/client-amplifybackend`](https://www.npmjs.com/package/@aws-sdk/client-amplifybackend/v/3.804.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.804.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EoszWhzZIrO7rA0L/+NbHUmvz4EOTgvzJb9vFj1DNuws42VdCFrUIDGEk6gOSB9Q
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-amplifybackend": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.804.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.804.0/index.min.mjs": "sha384-EoszWhzZIrO7rA0L/+NbHUmvz4EOTgvzJb9vFj1DNuws42VdCFrUIDGEk6gOSB9Q"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-amplifybackend/blob/refs/tags/3.804.0/LICENSE
```
