...
[`@aws-sdk/client-amplifybackend`](https://www.npmjs.com/package/@aws-sdk/client-amplifybackend/v/3.501.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.501.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mJRs9XOSImD6BFXYxHBexXhc1IVxLnwpE2MapA8GJ+ojOY/0f8kalQko/JTFyF5s
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-amplifybackend": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.501.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.501.0/index.min.mjs": "sha384-mJRs9XOSImD6BFXYxHBexXhc1IVxLnwpE2MapA8GJ+ojOY/0f8kalQko/JTFyF5s"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-amplifybackend/blob/refs/tags/3.501.0/LICENSE
```
