...
[`@aws-sdk/client-amplifybackend`](https://www.npmjs.com/package/@aws-sdk/client-amplifybackend/v/3.825.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.825.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZyLxgUOEa6SJstYq0XbWNWlVXHAa5yLMlpaPWXoXqwa5PeWQjiZAvwjZkiTMFIUE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-amplifybackend": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.825.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-amplifybackend@3.825.0/index.min.mjs": "sha384-ZyLxgUOEa6SJstYq0XbWNWlVXHAa5yLMlpaPWXoXqwa5PeWQjiZAvwjZkiTMFIUE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-amplifybackend/blob/refs/tags/3.825.0/LICENSE
```
